...
suspend fun BehaviourContext.handleModerateAddTeacherRequestCloseCallback(
    query: DataCallbackQuery,
    addTeacherRequestId: Int
) {
...
suspend fun BehaviourContext.handleModerateAddTeacherRequestCloseDoneCallback(
    query: DataCallbackQuery,
    addTeacherRequestId: Int
) {
    val (botUserEntity, _) = query.botUser()
